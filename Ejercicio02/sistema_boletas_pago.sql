...
-- Tiempo de generación: 12-05-2024 a las 22:12:14
...
(1, 'Oswaldo Henriquez', '123456789', 'Ventas', 'Vendedor', 'Tiempo completo', 1500.00),
(2, 'Francisco Peña', '987654321', 'Recursos Humanos', 'Gerente de RRHH', 'Tiempo completo', 2500.00),
(3, 'Jorge Flores', '456789123', 'Producción', 'Operario', 'Tiempo completo', 1400.00),
(4, 'Kevin Ramirez', '321654987', 'Contabilidad', 'Contador', 'Medio tiempo', 1800.00),
(5, 'Diego Estrada', '789123456', 'Marketing', 'Analista de Marketing', 'Tiempo completo', 2000.00);
COMMIT;
